...
### 一键安装
```
bash <(curl -Ls https://raw.githubusercontent.com/ChuJian2/XrayR-release/master/install.sh)
```
### 使用Docker部署软件
...
[Mozilla Public License Version 2.0](https://github.com/ChuJian2/XrayR/blob/master/LICENSE)
